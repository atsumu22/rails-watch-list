...
puts "Creating more and more movies!"
@data["results"].each do |movie|
  Movie.create!(title: movie["title"], overview: movie["overview"], poster_url: 'https://image.tmdb.org/t/p/w1280' + movie["poster_path"], rating: movie["vote_average"])
end
puts "done!"
